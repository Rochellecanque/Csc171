...
def shuffle():
    ...
    given = performpath(random,given,0)
    print given
...
def expand(node):
    ...
    neighbors.append(State(get_move(node.state, 1), node, 1, node.depth + 1, node.cost + 1, 0))
    neighbors.append(State(get_move(node.state, 2), node, 2, node.depth + 1, node.cost + 1, 0))
    neighbors.append(State(get_move(node.state, 3), node, 3, node.depth + 1, node.cost + 1, 0))
    neighbors.append(State(get_move(node.state, 4), node, 4, node.depth + 1, node.cost + 1, 0))
...
def expand2(node):
    ...
    neighbors2.append(State2(get_move(node.state2, 1), node, 1, node.depth2 + 1, node.cost2 + 1, 0))
    neighbors2.append(State2(get_move(node.state2, 2), node, 2, node.depth2 + 1, node.cost2 + 1, 0))
    neighbors2.append(State2(get_move(node.state2, 3), node, 3, node.depth2 + 1, node.cost2 + 1, 0))
    neighbors2.append(State2(get_move(node.state2, 4), node, 4, node.depth2 + 1, node.cost2 + 1, 0))
