...
class Gui:
    def __init__(self):
        ...
        self.board_img = pygame.image.load(os.path.join(
            "files", "board.bmp")).convert()
        self.black_img = pygame.image.load(os.path.join(
            "files", "preta.bmp")).convert()
        self.white_img = pygame.image.load(os.path.join(
            "files", "branca.bmp")).convert()
        self.tip_img = pygame.image.load(os.path.join("files",
                                                      "tip.bmp")).convert()
        self.clear_img = pygame.image.load(os.path.join("files",
                                                        "nada.bmp")).convert()
